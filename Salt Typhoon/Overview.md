...
* Leveraging this vulnerability, the actor was able to gain initial access into the target network.
    * The actor then issued a privilege 15 command to create a local user/password combination
* 
